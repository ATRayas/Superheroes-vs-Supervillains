...
//superheroes.all;//=> ['3-D Man', 'A-Bomb', …]
...
$("button").on("click", function(){
	...
	var supervillanName = supervillains.random();
    $(".fighters").text(superheroName + " vs " + supervillanName );
	console.log(superheroName, "vs", supervillanName );
})
